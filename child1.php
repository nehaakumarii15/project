...
.footer{
  ...
  <span class="text">Enter your child name</span>
</div>
     <div class="box1">
        <input type="text" name="email" placeholder="First name" required><br>
        <input type="text" name="email" placeholder="surnamename (optional)"><br>
